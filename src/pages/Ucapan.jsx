...
export default function Ucapan() {
    return (
        <div className='w-full mt-20 md:mt-40'>
            <h2 className='text-4xl md:text-5xl font-[Alice] mb-16 text-center text-white'>Ucapkan Sesuatu Untuk Kami Berdua</h2>
            <div className='flex flex-col md:flex-row'>
                <div className="flex flex-col p-4 w-[90%] md:w-[80%] mx-[5%] md:mx-[10%] bg-custom-white-sm py-8 md:py-10 text-[#282828] rounded-2xl md:rounded-xl mb-10" data-aos="zoom-in">
                    ...
                    <button className='w-full md:w-[25%] lg:w-[15%] bg-[#272726] text-white font-[Alegreya] text-2xl px-4 py-2 rounded-full'>Kirim</button>
