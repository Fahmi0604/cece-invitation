...
export default function Ucapan() {
    ...
    const createGreeting = () => {
        if (namaTamu !== '' && pesan !== '') {
            GreetingService.createGreeting({id_user: 1, nama_tamu: namaTamu, konfirmasi: JSON.parse(konfirmasi), pesan: pesan}).then(res => {
                getAllGreeting();
    ...
    return (
        ...
        <div className='w-full -mt-24 md:mt-4'>
            <div className='pb-[0] md:py-[10%]'>
                ...
                <div className='flex flex-col md:flex-row' data-aos="zoom-in">
                    <div className="flex flex-col p-4 w-[90%] md:w-[80%] mx-[5%] md:mx-[10%] bg-custom-white-sm py-8 md:py-10 text-[#282828] rounded-2xl md:rounded-xl mb-2">
                        <div className='mb-4'>
                        ...
                        <div className='mb-4'>
                            <div className='flex justify-between'>
                                ...
                                <label className="block mb-2 text-xs font-medium text-gray-300">{255 - pesan.length}</label>
                            </div>
                            ...
                            {greeting.map((e,i) => (
                                <div key={i} className='bg-[#D9D9D9] w-[90%] px-[5%] mb-4 rounded p-4'>
                                    <div className='flex justify-between items-center mb-4'>
                                        ...
                                        <h4 className={`text-xs bg-primary  text-white px-3 py-[2px] rounded`}>{e?.konfirmasi ? 'Hadir' : 'Tidak Hadir'}</h4>
                                    </div>
        ...
        <div className='w-[90%] md:w-[80%] mx-[5%] md:mx-[10%] mt-2 mb-2 md:mt-4 rounded bg-custom-white-sm p-2'>
            <div className='pb-[0]'>
                <img src="./assets/YennyOurstory.png" alt="" className='w-full rounded' />
            </div>
        </div>
        </>
    )
