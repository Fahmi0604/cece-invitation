...
export default function Modal({children, isOpen, setIsOpen}) {
    ...
    return (
        <>
        <div className={`${isOpen ? 'block' : 'hidden'} fixed inset-0 bg-black bg-opacity-50 overflow-hidden `} />
        <div className={`${isOpen ? 'block' : 'hidden'} flex flex-col justify-center items-center fixed inset-0 z-[7] p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-screen md:h-full`}>
